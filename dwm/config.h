...
static Key keys[] = {
	...
	{ MODKEY,			XK_t,	   spawn,		   {.v = browser } },
	{ MODKEY,			XK_v,	   spawn,		   {.v = steam } },
	{ MODKEY,			XK_p,	   spawn,		   {.v = fileman } },
	{ MODKEY,			XK_r, 	   spawn, 		   {.v = scriptRunner } },
	...
	{ MODKEY|ControlMask, 		XK_i,	   tagtoright,     {0} },
	{ MODKEY|ControlMask, 		XK_n,	   focusmon,       {.ui = -1 } },
	{ MODKEY|ControlMask, 		XK_e,	   focusmon,       {.ui = +1 } },
	{ MODKEY|ShiftMask,             XK_Up,     incnmaster,     {.i = +1 } },
	{ MODKEY|ShiftMask,             XK_Return, incnmaster,     {.i = -1 } },
